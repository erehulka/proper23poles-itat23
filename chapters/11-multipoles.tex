...
%		\item A \textit{loop} is an edge whose both ends are incident with the same vertex.
...
%\end{definition}
%
%Loops are not allowed in our work, although, for the sake of a complete definition, they are included in the types of edges. We define some properties of multipoles based on their edge ends, but at first, it is essential to define the edge ends, not incident with a vertex.
%
%\begin{definition}
...
One of the features of multipoles is connecting them to form bigger multipoles or even graphs. For this case, dividing $S(M)$ into pairwise disjoint tuples called \emph{connectors} is convenient.
