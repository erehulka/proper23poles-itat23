...
The study of \textit{snarks}, that is $2$-connected cubic graphs that are not 3-edge-colourable, is~important since they are smallest possible counterexamples for several open problems. To exclude trivial cases, some additional properties are considered like the following.
