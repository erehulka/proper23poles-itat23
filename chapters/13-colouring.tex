...
%From now on, if we say that a graph or a multipole is \textit{colourable}, we mean that there exists a 3-edge-colouring for that given construction.
