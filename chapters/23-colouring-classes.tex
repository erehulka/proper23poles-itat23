...
\begin{figure*}
	...
	\begin{subfigure}{0.16\textwidth}
		\scalebox{0.55}{
			\input{graphs/23-poles-colorings/2trianglesNo12_1.tex}
		}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.16\textwidth}
		\scalebox{0.55}{
			\input{graphs/23-poles-colorings/2trianglesNo12_2.tex}
		}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.16\textwidth}
		\scalebox{0.55}{
			\input{graphs/23-poles-colorings/2trianglesNo12_3.tex}
		}
	\end{subfigure}
	 \newline 
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 		\input{graphs/23-poles-colorings/2triangles1.tex}
	 	}
	 \end{subfigure}
	 \hfill
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 		\input{graphs/23-poles-colorings/2triangles2.tex}
	 	}
	 \end{subfigure}
	 \hfill
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 		\input{graphs/23-poles-colorings/2triangles3.tex}
	 	}
	 \end{subfigure}
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 ...
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 		\input{graphs/23-poles-colorings/almostPerfect.tex}
	 	}
	 \end{subfigure}
	 \hfill
	 \begin{subfigure}{0.16\textwidth}
	 	\scalebox{0.55}{
	 		\input{graphs/23-poles-colorings/perfect.tex}
	 	}
	 \end{subfigure}
	%\vspace{-1.1\baselineskip}
	\caption{Colouring graphs for class 1A (first three), 2B (last three in the first row), 2A (first three in the second row), 0B, 3B and 3A}
	\label{fig:colouring-classes}
\end{figure*}